...
define("JSON_PATH", {
  "INPUT_JSON": "E:\\data2\\exim_data\\3_analyzing", // "INPUT_JSON" : "./2_analyzing/jsons",
  "BACKUP_JSON": "E:\\data2\\exim_data\\3_analyzing\\jsons_ok", //대상 원문 백업 폴더 -> 일정시간 마다 삭제
  "PHRASE_JSON": "E:\\data2\\exim_data\\3_analyzing\\done", //분석된 구문 json파일 위치
  "ERR_JSON": "E:\\data2\\exim_data\\3_analyzing\\error" // BICA 분석 중 에러 발생시 원문 이동하는 패쓰
});
...
define("BICA_CONFIG", {
  ...
  "RETRY_TIME": 3,
  "RETRY_INTERVAL": 5000,
  "BICA_IP": '211.39.140.97', // '211.39.140.106',
